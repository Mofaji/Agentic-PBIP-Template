...
In this repository, `copilot-instructions.md` is the final authority.

If any guidance in this skill conflicts with `copilot-instructions.md`, follow `copilot-instructions.md`.

Mandatory repository rules for this skill:
- Create business measures in `_Measures` table only.
- Keep SVG KPI measures in `_SVG_Measures` with `P1_`, `P2_`, etc naming.
- Use PBIP/report/page/visual schema and property constraints from `copilot-instructions.md`.
- Follow repository formatting rules (whole numbers except allowed SVG-specific formatting, thousand separators, data labels enabled, sorting behavior).
