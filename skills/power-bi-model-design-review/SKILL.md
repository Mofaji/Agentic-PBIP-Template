...
When this review checklist conflicts with repository-specific PBIP rules (schema versions, visual/page/report allowed properties, measure table policy, SVG measure policy, naming and formatting constraints), prioritize `copilot-instructions.md`.
