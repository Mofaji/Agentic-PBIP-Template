...
When tuning model/report performance, preserve repository-specific authoring constraints from `copilot-instructions.md` (PBIP schema compliance, visual/report JSON property constraints, measure table conventions, and formatting rules).
