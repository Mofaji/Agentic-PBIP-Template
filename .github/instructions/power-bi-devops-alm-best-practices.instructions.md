...
For this repository, `copilot-instructions.md` is the final authority when any guidance conflicts.

Apply this document as DevOps and ALM guidance only after validating compatibility with `copilot-instructions.md`.

## Repository PBIP Structure Override

The generic examples in this guide may use `Model/` and `Report/` naming. In this repository, use the PBIP structure defined in `copilot-instructions.md`, including:

- `ProjectName.pbip`
- `ProjectName.Report/`
- `ProjectName.SemanticModel/`
- `StaticResources/RegisteredResources` for SVG backgrounds and custom themes
