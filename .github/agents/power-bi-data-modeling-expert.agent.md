...
- Measure placement in `_Measures`
- SVG KPI measure placement in `_SVG_Measures`
- PBIP/report/page/visual JSON schema and property constraints
- Repository naming and formatting conventions
