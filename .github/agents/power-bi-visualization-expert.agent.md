...
For this repository, `copilot-instructions.md` is the final authority.

When recommendations conflict, apply repository rules first, including:
- PBIP visual/page/report JSON schema versions and allowed property sets
- SVG background layering via `RegisteredResources`
- Visual container formatting constraints
- Axis, label, sorting, and naming conventions
